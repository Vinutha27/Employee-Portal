...
import com.example.employeemanagementsystem.Repository.SubmissionTypesRepository;
...
public class SubmissionTypesController {

	@Autowired
	private SubmissionTypesRepository submissionRepository;
	...
	public SubmissionTypes createSubmission( @RequestBody SubmissionTypes submissionTypes) {
		submissionTypes.setSubmissionID(sequenceGeneratorService.generateSequence(SubmissionTypes.SEQUENCE_NAME));
